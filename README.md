...
||| 
|-|-|
|<a href="ScreenShots\TargetingSystem\ReadMe\ScreenShots\CancelTargeting.PNG"></a>
<img src="ScreenShots\TargetingSystem\ReadMe\ScreenShots\CancelTargeting.PNG" width="300">|<a href="ScreenShots\TargetingSystem\ReadMe\ScreenShots\CancelTargeting.PNG"></a><img src="ScreenShots\TargetingSystem\ReadMe\ScreenShots\CancelTargeting.PNG" width="300">
...
First things first. This is a <b>Blueprints</b> only approach. A key part of this specific component is that lives in the <b>PlayerController</b>. Now that this is out of the way, in <b>Event BeginPlay</b> can safely take the <b>GetOwner</b> node and do a Casting in order to have a controller ref and then from the controlled Pawn can Cast to <b>Character</b> and promote to a variable. This is relatively ''safe'' because the classes player and controller as far as i understand will be always in memory, no matter what. </p>
...
<img src="ScreenShotsAndVids/ScreenShots/TargetingSystem/OverlapWithPawns.PNG" width="500">
</p>
...
<img src="ScreenShotsAndVids/ScreenShots/TargetingSystem/LoopOverPawns.PNG" width="500">
</p>
