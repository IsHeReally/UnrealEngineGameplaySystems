...
Over the last few months I decided to break away from copying and instead build my own systems. This document reflects that shift. The targeting system here allows the player to cycle through targets by pressing a key. The implementation is presented in three stages:
